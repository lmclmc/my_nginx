...
objs/nginx:	objs/src/core/nginx.o \
	...
	objs/addon/ngx_http_user_server_module/ngx_http_user_server_module.o \
	objs/addon/ngx_http_user_server_token_module/ngx_http_user_server_token_module.o \
	objs/addon/ngx_http_user_server_key_module/ngx_http_user_server_key_module.o \
	objs/ngx_modules.o
...
objs/addon/ngx_http_user_server_module/ngx_http_user_server_module.o:	$(ADDON_DEPS) \
	./ngx_http_user_server_module/ngx_http_user_server_module.c
	$(CC) -c $(CFLAGS)  $(ALL_INCS) \
		-o objs/addon/ngx_http_user_server_module/ngx_http_user_server_module.o \
		./ngx_http_user_server_module/ngx_http_user_server_module.c


objs/addon/ngx_http_user_server_token_module/ngx_http_user_server_token_module.o:	$(ADDON_DEPS) \
	./ngx_http_user_server_token_module/ngx_http_user_server_token_module.c
	$(CC) -c $(CFLAGS)  $(ALL_INCS) \
		-o objs/addon/ngx_http_user_server_token_module/ngx_http_user_server_token_module.o \
		./ngx_http_user_server_token_module/ngx_http_user_server_token_module.c


objs/addon/ngx_http_user_server_key_module/ngx_http_user_server_key_module.o:	$(ADDON_DEPS) \
	./ngx_http_user_server_key_module/ngx_http_user_server_key_module.c
	$(CC) -c $(CFLAGS)  $(ALL_INCS) \
		-o objs/addon/ngx_http_user_server_key_module/ngx_http_user_server_key_module.o \
		./ngx_http_user_server_key_module/ngx_http_user_server_key_module.c
...
install:	build 
	...
	test ! -f '$(DESTDIR).//sbin/nginx' \
		|| mv '$(DESTDIR).//sbin/nginx' \
			'$(DESTDIR).//sbin/nginx.old'
	cp objs/nginx '$(DESTDIR).//sbin/nginx'

	test -d '$(DESTDIR).//.' \
		|| mkdir -p '$(DESTDIR).//.'

	cp conf/koi-win '$(DESTDIR).//.'
	cp conf/koi-utf '$(DESTDIR).//.'
	cp conf/win-utf '$(DESTDIR).//.'

	test -f '$(DESTDIR).//./mime.types' \
		|| cp conf/mime.types '$(DESTDIR).//.'
	cp conf/mime.types '$(DESTDIR).//./mime.types.default'

	test -f '$(DESTDIR).//./fastcgi_params' \
		|| cp conf/fastcgi_params '$(DESTDIR).//.'
	cp conf/fastcgi_params \
		'$(DESTDIR).//./fastcgi_params.default'

	test -f '$(DESTDIR).//./fastcgi.conf' \
		|| cp conf/fastcgi.conf '$(DESTDIR).//.'
	cp conf/fastcgi.conf '$(DESTDIR).//./fastcgi.conf.default'

	test -f '$(DESTDIR).//./uwsgi_params' \
		|| cp conf/uwsgi_params '$(DESTDIR).//.'
	cp conf/uwsgi_params \
		'$(DESTDIR).//./uwsgi_params.default'

	test -f '$(DESTDIR).//./scgi_params' \
		|| cp conf/scgi_params '$(DESTDIR).//.'
	cp conf/scgi_params \
		'$(DESTDIR).//./scgi_params.default'

	test -f '$(DESTDIR).//./qwe.conf' \
		|| cp conf/nginx.conf '$(DESTDIR).//./qwe.conf'
	cp conf/nginx.conf '$(DESTDIR).//./nginx.conf.default'
